var TaskType;
(function (TaskType) {
    TaskType[TaskType["DestroyEnemyBots"] = 0] = "DestroyEnemyBots";
    TaskType[TaskType["Wins"] = 1] = "Wins";
    TaskType[TaskType["BeaconCapturing"] = 2] = "BeaconCapturing";
})(TaskType || (TaskType = {}));
var Prize;
(function (Prize) {
    Prize[Prize["Magnum"] = 0] = "Magnum";
    Prize[Prize["Blaze_Natasha"] = 1] = "Blaze_Natasha";
    Prize[Prize["Aphid"] = 2] = "Aphid";
    Prize[Prize["Trebuchet"] = 3] = "Trebuchet";
    Prize[Prize["Emerald_Griffin"] = 4] = "Emerald_Griffin";
    Prize[Prize["Trident"] = 5] = "Trident";
    Prize[Prize["Ancile"] = 6] = "Ancile";
    Prize[Prize["Carnage"] = 7] = "Carnage";
    Prize[Prize["Orkan"] = 8] = "Orkan";
    Prize[Prize["Shocktrain"] = 9] = "Shocktrain";
    Prize[Prize["Bulgasari"] = 10] = "Bulgasari";
})(Prize || (Prize = {}));
class SingleTask {
    constructor(init) {
...
class UserPace {
    ...
    static setPaceBasic(battleTime, win, kills, caps) {
    ...
    static setPaceAdvanced(win, kills, caps) {
